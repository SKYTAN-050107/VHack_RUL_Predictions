# NASA C-MAPSS FD001 Implementation Plan (Master Index)


This file is now the top-level controller for agent execution.


Use the step files in `implementation_plan/` in strict order:


1. `implementation_plan/00_agent_runbook.md`
2. `implementation_plan/01_data_and_labeling.md`
3. `implementation_plan/02_features_and_splitting.md`
4. `implementation_plan/03_modeling_core.md`
5. `implementation_plan/04_optional_sequence_and_uncertainty.md`
6. `implementation_plan/05_evaluation_interpretation_and_ablation.md`


## What Changed


- Preserved full original pipeline content in this file for reference.
- Converted execution flow into modular, agent-ready instructions.
- Marked deep-learning and stacking stages as optional unless they provide measured gains.
- Added explicit acceptance gates, deliverables, and stop conditions per phase.


## Notes From Sources Applied To The Plan


- Kept sequence models as optional extensions rather than default ship path.
- Emphasized robust feature engineering and boosting baselines before deep models.
- Added uncertainty reporting as a required output for maintenance decision support.
